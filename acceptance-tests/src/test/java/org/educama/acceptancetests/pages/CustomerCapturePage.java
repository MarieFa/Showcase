...
public class CustomerCapturePage extends PageObject {
    ...
    public void createCustomer(String name, boolean save) {

        formFieldCustomerName.sendKeys(name);
        formFieldAddressStreet.sendKeys("Beispielstrasse");
        formFieldAddressHouseNumber.sendKeys("1");
        formFieldAddressPostalCode.sendKeys("1234");
        formFieldAddressCity.sendKeys("Seoul");
